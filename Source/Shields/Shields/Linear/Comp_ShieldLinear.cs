...
namespace FrontierDevelopments.Shields.Linear
{
    public class Comp_ShieldLinear : Comp_ShieldBase, ILinearShield
    {
            ...
            get
            {
                ...
                if (_links.Any())
                {
                    yield return new TitledSectionComponent(
                        ...
                        _links.Select(link => new ShieldLinearLinkUiComponent(link, this)).OfType<UiComponent>()
                            .ToList());
                }
            }
        }
        ...
        private bool LinkedWith(ILinearShield other)
        {
            return _links.Any(link => link.Has(other));
        }
