...
namespace FrontierDevelopments.Shields.Linear
{
    public static class LinearShieldUtility
    {
        ...
        public static float CalculateFieldEfficiency(float distance, int oneEfficientRange = 0,
            int twoEfficientRange = 0)
        {
        ...
        {
            DrawFieldBetween(CellsBetween(one, two).ToList(), map, color);
        }
    }
}