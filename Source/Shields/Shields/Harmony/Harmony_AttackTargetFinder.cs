...
namespace FrontierDevelopments.Shields.Harmony
{
    public class Harmony_AttackTargetFinder
    {
        ...
        {
            [HarmonyPostfix]
            private static float AdjustScoreForShieldedTargets(float __result, IAttackTarget target,
        ...
        {
            [HarmonyPostfix]
            private static bool CanShootAtShieldFromCurrentPosition(bool __result, IAttackTarget target,
