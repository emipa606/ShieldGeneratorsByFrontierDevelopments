...
namespace FrontierDevelopments.Shields.Harmony
{
    public class Harmony_Projectile
    {
        ...
        private static bool Impact(Projectile projectile)
        {
        ...
        {
            return projectile is Projectile_Explosive || projectile.AllComps.OfType<CompExplosive>().Any();
        }
        ...
        [UsedImplicitly]
        private static class Patch_CheckForFreeInterceptBetween
        {
            [HarmonyPostfix]
            private static bool AddShieldCheck(
                bool __result,
                    ...
                    return TryBlockProjectile(__instance,
                        ...
                        (_, _) =>
                        {
                            ...
                            else
                            {
                                ...
                                if (!IsExplosive(__instance) || !Impact(__instance))
                                {
