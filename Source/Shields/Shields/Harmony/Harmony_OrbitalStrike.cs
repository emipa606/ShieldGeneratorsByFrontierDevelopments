...
{
    internal class Harmony_OrbitalStrike
    {
        private static readonly MethodInfo canStartFleeingBecauseOfPawnAction =
            AccessTools.Method(typeof(Pawn_MindState), "CanStartFleeingBecauseOfPawnAction");
        ...
        protected class Transpiler_TryStartFireIn
        {
            ...
            public IEnumerable<CodeInstruction> Apply(string methodName,
                IReadOnlyCollection<CodeInstruction> instructions, ILGenerator il)
            {
        ...
        private static class Patch_Tick
        {
            ...
            [HarmonyPostfix]
            private static void HavePawnsFleeFromOrbitalStrikes(OrbitalStrike __instance)
            {
                ...
                RegionTraverser.BreadthFirstTraverse(__instance.Position, __instance.Map, (_, _) => true, region =>
                {
