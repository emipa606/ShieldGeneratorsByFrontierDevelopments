...
//                    icon = Resources.UiChargeBattery,
        ...
        {
            return "PowerBatteryStored".Translate() + ": " + StoredEnergy.ToString("F0") + " / " +
                   Props.storedEnergyMax.ToString("F0") + " Wd" + ", " + "PowerBatteryEfficiency".Translate() + ": " +
        ...
        public override void PostExposeData()
        {
            ...
            Scribe_Values.Look(ref storedEnergy, "storedPower");
